          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {wsConnected !== undefined && (
              <div
                ...
                title={wsConnected ? "Live — dashboard updates automatically" : "Polling"}
              >
                <span className={`w-1.5 h-1.5 rounded-full ${wsConnected ? "bg-[#10b981] animate-pulse" : "bg-[#d1d5db]"}`} />
            ...
            <button
              ...
              className="w-8 h-8 rounded-lg border border-[#e5e7eb] bg-white flex items-center justify-center
                text-[#9ca3af] hover:text-[#ef4444] hover:border-[#fca5a5] hover:bg-[#fef2f2]
                transition-colors"
